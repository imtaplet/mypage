...
view =
    let
        ...
        faqList =
            [ faq "No.1 あなたのハンドルネームは？" "imtaplet （いんたっぷれっと）です❗長いと思う方は、'いんたぷ' と呼んでください❗"
            , faq "No.2 どこに住んでますか？" "amazon の届く地理です。故郷は、インターネットだと思うようにしています。"
            , faq "No.3 好きな食べ物は？" "マイスリー\u{1F7E0}"
            , faq "No.4 職業は？" "闘病中のためニートですが、本人はプログラマだと思いこんでる模様です\u{1F914}"
            , faq "No.5 恋人はいますか？" "恋人は、マイスリーです。辛いときも悲しいときも一緒にいてくれました✨"
            , faq "No.6 あなたの口ぐせはなに？" "「もうだめだ😨」"
            , faq "No.7 長所はなに？" "マイスリーとモンエナを入力にクソコードを出力できる。"
            , faq "No.8 短所はなに？" "すぐ寝る😴"
            , faq "No.9 人に言えない秘密はなに？" "基本、死ぬことしか考えてない。"
            , faq "No.10 自分について何でもいいので語ってください。" "悲観的で落ち込みやすい性格です。極端なこだわりや強迫観念も強いので生きるのが辛いです。"
            ]
                |> List.concat
    in
    article []
